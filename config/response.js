...
export const baseResponse = {
    ...
    //유저 관련 오류
    USER_USERID_NOT_EXIST : { "isSuccess": false, "code": 2001, "message": "해당 유저가 존재하지 않습니다." },

    USER_USERID_EMPTY : { "isSuccess": false, "code": 2002, "message": "user_Id를 입력해주세요." },

    USER_USER_NICKNAME_LENGTH : { "isSuccess": false, "code": 2002, "message": "닉네임 길이 제한을 초과하였습니다." },

    POST_POSTID_NOT_EXIST : { "isSuccess": false, "code": 2101, "message": "해당 게시글이 존재하지 않습니다." },
